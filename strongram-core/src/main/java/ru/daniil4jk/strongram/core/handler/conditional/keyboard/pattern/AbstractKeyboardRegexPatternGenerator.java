...
@Getter
public class AbstractKeyboardRegexPatternGenerator implements KeyboardRegexPatternGenerator {
    private static final Pattern EMPTY_PATTERN = Pattern.compile("(?!)");

    private final Pattern pattern;

    public AbstractKeyboardRegexPatternGenerator(Stream<String> buttonPayloads) {
