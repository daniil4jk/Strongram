...
@Getter
public class ChainedBotWithDefaults extends ChainedBot {
    ...
    public ChainedBotWithDefaults(BotCredentials credentials) {
        super(credentials);
    }

    public ChainedBotWithDefaults(TelegramClient telegramClient, BotCredentials credentials) {
