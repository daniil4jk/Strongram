...
import ru.daniil4jk.strongram.handler.conditional.ConditionalUpdateHandler;
import ru.daniil4jk.strongram.handler.conditional.keyboard.pattern.KeyboardPatternGenerator;
import ru.daniil4jk.strongram.handler.conditional.keyboard.registry.KeyboardSpecificButtonRegistry;
...
public abstract class KeyboardUpdateHandler<Keyboard extends ReplyKeyboard, Button> extends ConditionalUpdateHandler {
    ...
    public KeyboardUpdateHandler(Keyboard keyboard) {
        super(KeyboardPatternGenerator.getByKeyboard(keyboard).getPattern());
